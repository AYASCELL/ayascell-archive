#[Rehber] Arch Linux: systemd-boot ve sbctl ile Otomatik Secure Boot Kurulumu
...
[GUIDE] Arch Linux: Automated Secure Boot Setup with systemd-boot and sbctl
...
## 3. Checking the signature status of the bootloader and kernel files in the EFI directory.
...
## 4. Creating our own custom Secure Boot keys to take control of the system.
ayascell@ayascell-dell-g15-5530 ~> sudo sbctl create-keys
Created Owner UUID id
Creating secure boot keys...✔
Secure boot keys created!

## 5. Enrolling the generated keys into the motherboard's BIOS alongside the Microsoft keys.
ayascell@ayascell-dell-g15-5530 ~> sudo sbctl enroll-keys -m
Enrolling keys to EFI variables...✔
Enrolled keys to the EFI variables!

## 6. Signing our unsigned systemd-boot and Kernel files with our custom key.
ayascell@ayascell-dell-g15-5530 ~> sudo sbctl sign-all
✓ Signed /boot/efi/EFI/BOOT/BOOTX64.EFI
✓ Signed /boot/efi/EFI/systemd/systemd-boot-fallbackx64.efi
✓ Signed /boot/efi/EFI/systemd/systemd-bootx64.efi
